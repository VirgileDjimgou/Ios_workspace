...
class MyLocationManager : NSObject, CLLocationManagerDelegate {
                       ...
                       didUpdateLocations locations: [CLLocation])
  {
    ...
    NSNotificationCenter.defaultCenter().postNotificationName("NewLocation", object: manager)
  }
    ...
    didUpdateHeading newHeading: CLHeading)
  {
    ...
    NSNotificationCenter.defaultCenter().postNotificationName("NewHeading", object: manager)
  }
