...
class ChessFigure {
  ...
  required init(_ position:String) {
...
// impliziter Upcast
var cf1:ChessFigure = Pawn("h2")
var cf2 = Pawn("h2") as ChessFigure // gleichwertig
...
figures.append(Pawn("a2"))
figures.append(Pawn("b2"))
figures.append(King("b2"))
...
if let k = figures[2] as? King {  // Typtest und Downcast
  print(k.hasCastled)             // zugleich mit as?, Ergebnis false
}
