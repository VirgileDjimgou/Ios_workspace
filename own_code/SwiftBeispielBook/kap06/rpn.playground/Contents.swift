// Hinweis: in Xcode 7.0 final sind die print-Ausgaben im Playground leider
// nicht sichtbar. Wenn Sie denselben Code in einem kompilierten
// Programm ausführen, erscheinen die Ausgaben.
...
func calculate(fn:(Double, Double)->Double) {
  if stack.count >= 2 {
...
func calculate(fn:(Double)->Double) {
  if stack.count >= 1 {
